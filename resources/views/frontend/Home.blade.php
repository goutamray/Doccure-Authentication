...
<section class="section section-search">
    <div class="container-fluid">
        <div class="banner-wrapper">
            <div class="banner-header text-center aos"
                data-aos="fade-up">
            ...
            <div class="search-box">
                <form action="search.html">
                    <div class="mb-3 search-location aos"
                        data-aos="fade-up">
                        <input type="text"
                            class="form-control"
                    ...
                    <div class="mb-3 search-info aos"
                        data-aos="fade-up">
                        <input type="text"
                            class="form-control"
                    ...
                    <button type="submit"
                        ...
                        data-aos="fade-up"><i class="fas fa-search"></i> <span>Search</span></button>
                </form>
            </div>
            <!-- /Search -->
                ...
                <div class="row">
                    <div class="col-lg-4 mb-3 aos"
                        ...
                        <div class="card text-center doctor-book-card">
                            <img src="frontend/assets/img/doctors/doctor-07.jpg"
                                alt="doctor-image"
                                class="img-fluid">
                    ...
                    <div class="col-lg-4 mb-3 aos"
                        data-aos="fade-up">
                        <div class="card text-center doctor-book-card">
                            <img src="frontend/assets/img/img-pharmacy1.jpg"
                                alt="pharmacy image"
                                class="img-fluid">
                            <div class="doctor-book-card-content tile-card-content-1">
                                <div>
                    ...
                    <div class="col-lg-4 mb-3 aos"
                        data-aos="fade-up">
                        <div class="card text-center doctor-book-card">
                            <img src="frontend/assets/img/lab-image.jpg"
                                alt="lab-image"
                                class="img-fluid">
                            <div class="doctor-book-card-content tile-card-content-1">
                                <div>
                ...
                <div class="specialities-slider slider">
                    ...
                    <div class="speicality-item text-center">
                        <div class="speicality-img">
                            <img src="frontend/assets/img/specialities/specialities-01.png"
                                class="img-fluid"
                                alt="Speciality">
                    ...
                    <div class="speicality-item text-center">
                        <div class="speicality-img">
                            <img src="frontend/assets/img/specialities/specialities-02.png"
                                class="img-fluid"
                                alt="Speciality">
                            <span><i class="fa fa-circle"
                                    aria-hidden="true"></i></span>
                    ...
                    <div class="speicality-item text-center">
                        <div class="speicality-img">
                            <img src="frontend/assets/img/specialities/specialities-03.png"
                                class="img-fluid"
                                alt="Speciality">
                            <span><i class="fa fa-circle"
                                    aria-hidden="true"></i></span>
                    ...
                    <div class="speicality-item text-center">
                        <div class="speicality-img">
                            <img src="frontend/assets/img/specialities/specialities-04.png"
                                class="img-fluid"
                                alt="Speciality">
                            <span><i class="fa fa-circle"
                                    aria-hidden="true"></i></span>
                    ...
                    <div class="speicality-item text-center">
                        <div class="speicality-img">
                            <img src="frontend/assets/img/specialities/specialities-05.png"
                                class="img-fluid"
                                alt="Speciality">
                            <span><i class="fa fa-circle"
                                    aria-hidden="true"></i></span>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-01.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-02.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-03.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-04.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-05.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-06.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-07.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
                    ...
                    <div class="profile-widget">
                        <div class="doc-img">
                            <a href="doctor-profile.html">
                                <img class="img-fluid"
                                    alt="User Image"
                                    src="frontend/assets/img/doctors/doctor-08.jpg">
                            </a>
                            <a href="javascript:void(0)"
                                class="fav-btn">
                                <i class="far fa-bookmark"></i>
...
<section class="section section-features">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5 features-img aos"
                data-aos="fade-up">
                <img src="frontend/assets/img/features/feature.png"
                    class="img-fluid"
                    alt="Feature">
            </div>
            <div class="col-md-7 aos"
                data-aos="fade-up">
                <div class="section-header">
                ...
                <div class="features-slider slider">
                    ...
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-01.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>Patient Ward</p>
                    </div>
                    ...
                    <!-- Slider Item -->
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-02.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>Test Room</p>
                    </div>
                    ...
                    <!-- Slider Item -->
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-03.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>ICU</p>
                    </div>
                    ...
                    <!-- Slider Item -->
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-04.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>Laboratory</p>
                    </div>
                    ...
                    <!-- Slider Item -->
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-05.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>Operation</p>
                    </div>
                    ...
                    <!-- Slider Item -->
                    <div class="feature-item text-center">
                        <img src="frontend/assets/img/features/feature-06.jpg"
                            class="img-fluid"
                            alt="Feature">
                        <p>Medical</p>
                    </div>
...
<section class="section section-blogs">
    <div class="container-fluid">
        ...
        <div class="row blog-grid-row">
            <div class="col-md-6 col-lg-3 col-sm-12 aos"
                data-aos="fade-up">
                ...
                <div class="blog grid-blog">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid"
                                src="frontend/assets/img/blog/blog-01.jpg"
                                alt="Post Image"></a>
                    </div>
                            ...
                            <li>
                                <div class="post-author">
                                    <a href="doctor-profile.html"><img
                                            src="frontend/assets/img/doctors/doctor-thumb-01.jpg"
                                            alt="Post Author">
            ...
            <div class="col-md-6 col-lg-3 col-sm-12 aos"
                ...
                <div class="blog grid-blog">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid"
                                src="frontend/assets/img/blog/blog-02.jpg"
                                alt="Post Image"></a>
                    </div>
                    <div class="blog-content">
                        <ul class="entry-meta meta-item">
                            <li>
                                <div class="post-author">
                                    <a href="doctor-profile.html"><img
                                            src="frontend/assets/img/doctors/doctor-thumb-02.jpg"
                                            alt="Post Author">
                        ...
                        <h3 class="blog-title"><a href="blog-details.html">What are the benefits of Online
                                Doctor Booking?</a></h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do
                            eiusmod tempor.</p>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 col-sm-12 aos"
                ...
                <div class="blog grid-blog">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid"
                                src="frontend/assets/img/blog/blog-03.jpg"
                                alt="Post Image"></a>
                    </div>
                    <div class="blog-content">
                        <ul class="entry-meta meta-item">
                            <li>
                                <div class="post-author">
                                    <a href="doctor-profile.html"><img
                                            src="frontend/assets/img/doctors/doctor-thumb-03.jpg"
                                            alt="Post Author">
            ...
            <div class="col-md-6 col-lg-3 col-sm-12 aos"
                ...
                <div class="blog grid-blog">
                    <div class="blog-image">
                        <a href="blog-details.html"><img class="img-fluid"
                                src="frontend/assets/img/blog/blog-04.jpg"
                                alt="Post Image"></a>
                    </div>
                    <div class="blog-content">
                        <ul class="entry-meta meta-item">
                            <li>
                                <div class="post-author">
                                    <a href="doctor-profile.html"><img
                                            src="frontend/assets/img/doctors/doctor-thumb-04.jpg"
                                            alt="Post Author">
